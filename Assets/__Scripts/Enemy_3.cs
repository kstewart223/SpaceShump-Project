...
public class Enemy_3 : Enemy
{
    ...
    public Vector2 midpointRange = new Vector2(1.5f, 3);
    ...
    void Start()
    {
        ...
        float xMin = -bndCheck.camWidth + bndCheck.raidus;
        float xMax = bndCheck.camWidth - bndCheck.raidus;

        points[1] = Vector3.zero;
        points[1].x = Random.Range(xMin,xMax);
        float midYMult = Random.Range(midpointRange[0], midpointRange[1]);
    ...
    void DrawDebug()
    {
        ...
        for(int i = 1; i < numSections; i++)
        {
            ...
            Debug.DrawLine(prevPoints, pt, col, lifeTime);
            prevPoints = pt;
        }
    }
